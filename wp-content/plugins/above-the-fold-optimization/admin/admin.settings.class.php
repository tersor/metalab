										...
										<div class="inside">
											<table class="form-table">
												<tr valign="top">
													...
													<td>
														<label><input type="checkbox" name="abovethefold[loadcss_enhanced]" value="1"<?php if (!isset($options['loadcss_enhanced']) || intval($options['loadcss_enhanced']) === 1) { print ' checked'; } ?>> Enabled</label>
